...
import os
os.environ["LANGSMITH_API_KEY"] = setting.langsmith_api_key
os.environ["LANGSMITH_TRACING"] = setting.langsmith_tracing                                                       
os.environ["LANGSMITH_PROJECT"] = setting.langsmith_project
